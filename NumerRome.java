...
public enum NumerRome {
    O(0),
    I(1), II(2), III(3), IV(4), V(5), VI(6), VII(7), VIII(8), IX(9), X(10),
    XI(11), XII(12), XIII(13), XIV(14), XV(15), XVI(16), XVII(17), XVIII(18), XIX(19), XX(20),
    XXI(21), XXII(22), XXIII(23), XXIV(24), XXV(25), XXVI(26), XXVII(27), XXVIII(28), XXIX(29),
    XXX(30), XXXI(31), XXXII(32), XXXIII(33), XXXIV(34), XXXV(35), XXXVI(36), XXXIIV(37), XXXVIII(38), XXXIX(39),
    ...
    String getRomeNum(int i) {
        NumerRome allnumerRome[] = NumerRome.values();

        if (i > 0) {
            return allnumerRome[i].toString();
        } else {
            return "-" + allnumerRome[Math.abs(i)].toString();
